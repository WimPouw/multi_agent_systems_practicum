...
* Lets design a measure the diffusion of the population
* `positions_x = [agent.cell.coordinate[0] for agent in model.agents]`
* `positions_y = [agent.cell.coordinate[1] for agent in model.agents]`
