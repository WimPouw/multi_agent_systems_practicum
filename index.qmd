...
* **Creative adaptation:** Create your own variation of the model.
* **Python Challenge to take home:** Try to implement the dispersal model on the map.

## Practicum 4

* **Python Challenge:** Showing the dispersal map implementation.
* **Learn to create your own visualizations**. Using Solara and Matplotlib.
* **Model:** Introduction to the El Faro model.
* **Mesa's Data Collector:** Running and collecting data.
* **Run a formal experiment**: Using Mesa batch we will performa an experiment.

## Practicum 5

* **Introduction to Agent sets**: Learn how to use agent sets in Mesa.
* **Models:** Wolf-sheep model & Amphor model.
* **Mesa's Data Collector:** Running an experiment and statistically analyzing data.
* **Analysis:** Using your knowledge from Statistics II.

## Practicum 6
* **DIY building models yourself**: Code up your own simple model and collect some data.
* **Feasibility**: You will learn your limitations and feasable scope of a model.
