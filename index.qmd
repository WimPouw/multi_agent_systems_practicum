...
## Basic models
* [Basic Grid, Continuous, Network Model Folder Python](./models/basic_python_models.zip)
* [Basic Grid, Continuous, Network Model Folder Netlogo](./models/basic_netlogo_models.zip)
...
* [Example custom visualizations folder](./models/examples_custom_visualizations.zip)
...
* [Download Full Functionality Overview Model Folder Python](./models/fullfunc_grid_python_model.zip)
...
* [Download Dispersal Model Folder Netlogo](./models/dispersal_netlogo.zip)
...
* [Download Dispersal Model Translation Part II Folder Python (incomplete)](./models/dispersal_python_partII.zip)

### Simple Dispersal Model After Practicum 3
* [Dispersal Model Simple Folder Python (partially completed)](./models/dispersal_python_afterpartII.zip)
...
* [Download Criticality Fire Model Folder Python](./models/fire_model_python.zip)
* [Download Criticality Fire Model Folder Netlogo](./models/fire_model_netlogo.zip)

:::

::: {.callout-note .callout-download collapse="true"}
## Flocking model
* [Flocking Model Folder Python](./models/flocking_model_python.zip)
* [Flocking Model Folder Netlogo](./models/flocking_model_netlogo.zip)
:::
::: {.callout-note .callout-download collapse="true"}
## El Farol Model
* [El Farol Model Folder Python](./models/elfarol_model_python.zip)
  * [El Farol Solution Practicum 5](./models/elfarol_model_extended.zip)
* [El Farol Model Folder Netlogo](./models/elfarol_model_netlogo.zip)
:::

::: {.callout-note .callout-download collapse="true"}
## Amphor Model
* TODO Python
* [Amphor Model Folder Netlogo](./models/amphor_model_netlogo.zip)
:::

::: {.callout-note .callout-download collapse="true"}
## Wolf-Sheep Model
* [Wolf-Sheep Model Folder Python](./models/wolfsheep_model_python.zip)
* [Wolf-Sheep Model Folder Python (practicum 6 solution)](./models/wolfsheep_solution_python.zip)
* [Wolf-Sheep Folder Netlogo](./models/wolfsheep_model_netlogo.zip)
:::
