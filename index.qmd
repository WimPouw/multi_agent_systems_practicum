...
* **Part II: Implementation from scratch:** We continue to practice model translation.
...
* **Run a formal experiemnt**: Using Mesa batch we will performa an experiment.
...
For Mac users the above procedure does not work and you need to follower a slightly different procedure. You run conda commands in your terminal instead. And another key difference is that we do not explicitly set the version for mesa (and you download extra dependencies such as networkx in addition).
