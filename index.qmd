...
- [Mesa core example model library](https://github.com/projectmesa/mesa-examples)
...
- Netlogo model library by [@wilenskyIntroductionAgentBasedModeling2015]
- Netlogo model library [@romanowskaAgentBasedModelingArchaeology2021]
