---
title: "Multi-Agent Systems Practicum 1a"
...
## Agenda
- Intro and live setup and how to with troubleshoot Wim
- Self-work with some coding exercises to prepare you for python mesa
...
- Models, slides, coding excercises, and reference literature.
- Slides will be available or updated right before practicum
...
- Tested on the practicum PC (and my own Windows PC and Linux laptop), should work for OS. Otherwise well troubleshoot, there is time!
...
# See you next time!
- Reach out on Canvas if you have questions.
